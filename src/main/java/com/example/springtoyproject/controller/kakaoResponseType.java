...
public enum kakaoResponseType {
    ...
    public void setQuickReplies(JSONObject output,String content,String id){
        JSONArray QuickReplies = new JSONArray();
        JSONObject button = new JSONObject();

        button.put("label",content);
        button.put("action","block");
        button.put("messageText",content);
        button.put("blockId",id);

        output.put("quickReplies",QuickReplies);
    }
